...
import com.racinekanedev.payload.dto.*;
...
public class KeycloackUserService {
    ...
    private static final String CLIENT_ID = "ndankndank-client";
    private static final String CLIENT_SECRET = "7NAiHfwDZq61jBsYLzCToLcOFulv29VF"; // Replace with your client secret
    private static final String GRANT_TYPE = "password";
    private static final String scope = "openid email profile";
    private static final String username = "admin";
    private static final String password = "admin";
    private static  final String clientId = "91cdf394-fe90-48d8-96e1-532a9870f32f";
